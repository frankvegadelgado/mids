...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_mid", description="Solve the Approximate Independent Dominating Set for all undirected graphs encoded in DIMACS format and stored in a directory.")
